...
(function () {
  ...
  var FR = {
    ...
    "proc.s1_body": "Dorade, loup et maigre élevés en cages offshore sur une concession gouvernementale de 375 ha à Ras El Ma. Protocoles de biosécurité intégrés dès la conception, et non greffés a posteriori.",
    ...
    "proc.s3_body": "Une chaîne du froid ininterrompue préserve la fraîcheur, de la récolte à la livraison. Chaque lot étiqueté, documenté et traçable de bout en bout — un interlocuteur, un dossier documentaire, une promesse tenue.",
    ...
    "doors.title": "Une chaîne intégrée.<br><em>Trois convictions.</em>",
    "door1.label": "Distributeurs",
    "door1.title": "Un interlocuteur unique, de bout en bout.",
    "door1.body":  "Dorade, loup et maigre — élevés en Méditerranée et exportés via Ras Kebdana. Dossier documentaire complet. Traçabilité IoT par lot. Une montée en volumes progressive pour les partenaires long terme.",
    "door1.link":  "Ouvrir la présentation commerciale",
    "door2.label": "Clients",
    "door2.title": "Une thèse solide.<br>Une sortie qui se dessine.",
    "door2.body":  "Concession de 375 ha sécurisée. Demande documentée, marché sous-approvisionné. La valeur n’est pas dans les cages seules — elle est dans la chaîne intégrée, avec hatchery et unité d’alimentation inscrites dans notre feuille de route pour ancrer une infrastructure régionale.",
    "door2.link":  "Demander plus d’informations",
    "door3.label": "Presse &amp; institutions",
    "door3.title": "Le blueprint, documenté.",
    "door3.body":  "Bien construit dès le premier jour. Biosécurité, énergie solaire, un objectif d’au moins 40 % de femmes dans les emplois directs, traçabilité IoT — intégrés, pas cosmétiques. Le modèle que l’Afrique du Nord regardera demain.",
    ...
    "mani.signoff": "Ancrés au Maroc par conviction. Construits pour le monde.",
